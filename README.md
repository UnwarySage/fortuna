...
* [`src/cljs/fortuna/`](src/cljs/fortuna/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/fortuna/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `fortuna` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/fortuna/config.cljs) defaults to `true` in
...
```clj
(ns fortuna.example
  (:require [fortuna.config :as config])
